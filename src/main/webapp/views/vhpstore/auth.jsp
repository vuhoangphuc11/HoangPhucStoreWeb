...
<main>
    <section class="container stylization maincont">
        ...
        <div class="auth-wrap">
            <div class="auth-col-center">
                <h2>Login</h2>
                <h4>${message}</h4>
                <form action="/home/auth" method="post" class="login">
                    <p>
                        <label for="username">E-mail <span class="required">*</span></label><input type="text" id="username" name="username">
                    </p>
                    <p>
                        <label for="password">Password <span class="required">*</span></label><input type="password" id="password" name="password">
                    </p>
                    <p class="auth-submit">
                        <input type="submit" value="Login">
                        <input type="checkbox" id="rememberme" value="forever" name="remember">
