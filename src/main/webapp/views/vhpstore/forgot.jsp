    ...
    <section class="container stylization maincont">
        ...
        <div class="auth-wrap">
            <div class="auth-col-center">
                ...
                <h4>${message}</h4>
                <form action="/home/forgot/sendmail" method="post" class="login">
                    <p>
                        <label for="username">Username <span class="required">*</span></label><input type="text" id="username" name="username">
                    </p>
                    <p>
                        <label for="password">Email <span class="required">*</span></label><input type="text" id="email" name="email">
                    </p>
                    <p class="auth-submit">
