		...
		<div class="collapse navbar-collapse" id="navbarNavAltMarkup">
			<div class="navbar-nav">
				<a class="nav-item nav-link " href="/admin/home">Home <span
					...
					href="/admin/category">Category</a> <a class="nav-item nav-link "
					href="/admin/account">Account</a> <a
					class="nav-item nav-link active" href="/admin/product">Product</a>
			</div>
		</div>
	</nav>
	...
	<div class="mx-auto" style="width: 400px;">
		...
		<div class="row">
			...
			<form:form action="/admin/product" modelAttribute="item">
				...
				<button formaction="/admin/product/delete/${item.id}"
