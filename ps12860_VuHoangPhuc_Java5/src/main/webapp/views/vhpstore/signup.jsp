    ...
    <section class="container stylization maincont">
        ...
        <div class="auth-wrap">
            <div class="auth-col-center">
                <h2>Register</h2>
                <h3>${message}</h3>
                <form action="/home/signup/create" method="post" class="register">
                    <p>
                    ...
                    <p>
                        <label>Fullname <span class="required">*</span></label><input type="text" name="fullname"> 
                    </p>
                    <p>
                        <label>Email <span class="required">*</span></label><input type="email" name="email">
                    </p>
                    <p>
                        <label>Photo <span class="required">*</span></label><input type="file" name="photo">
                    </p>
                    <p class="auth-submit">
