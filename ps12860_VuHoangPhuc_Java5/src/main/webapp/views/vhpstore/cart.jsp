...
<body>
	...
	<main>
		<section class="container stylization maincont">
			...
			<div class="cart-items-wrap">
				<table class="cart-items">
					...
					<c:forEach var="item" items="${cart.items}">
						...
						<form action="/home/cart/update/${item.id}" method="post">
							<tbody>

								<tr>

									<td class="cart-image"><a href="product"> <img
											src="http://placehold.it/61x80"
											alt="Similique delectus totam">
									</a></td>

									<td class="cart-ttl"><a href="product">${item.name}</a>
										<p>Color: Red</p>
										<p>Size: XS</p></td>
									<td class="cart-price"><b>${item.price}</b></td>
									...
									<td class="cart-summ"><b>${item.price * item.qty}</b>
										<p class="cart-forone">
											unit price <b>$220</b>
										</p></td>
									<td class="cart-del"><a
										href="/home/cart/remove/${item.id}" class="cart-remove"></a></td>
								</tr>
			...
			<ul class="cart-total">
				<li class="cart-summ">TOTAL: <b>${cart.amount}</b></li>
			</ul>
			<div class="cart-submit">
				...
				<a href="/home/cart/clear" class="cart-clear">Clear cart</a>
			</div>
